...
def search_listings(location: str, bedrooms: int, max_rent: int = 0, features: str = "") -> str:
    ...
    if "95136" in loc_lower or "san jose" in loc_lower:
        return (
            ...
            f"- **Preference Match:** ⚡ **96% Match with Your Preferences** (Budget ✓, Bedrooms ✓, San Jose Location ✓, Fiber Internet ✓)\n"
            ...
            f"- **Preference Match:** ⚡ **91% Match with Your Preferences** (Bedrooms ✓, San Jose Location ✓, EV Charging ✓, High-Speed Internet ✓)\n"
        ...
        return (
            ...
            f"- **Preference Match:** ⚡ **98% Match with Your Preferences** (Skyline Views ✓, Concierge ✓, Pet Friendly ✓, Location ✓)\n"
            ...
            f"- **Preference Match:** ⚡ **89% Match with Your Preferences** (High Ceilings ✓, In-Unit Laundry ✓, Gas Stove ✓)\n"
        ...
        return (
            ...
            f"- **Preference Match:** ⚡ **95% Match with Your Preferences** (Central Park View ✓, 24/7 Doorman ✓, Midtown Location ✓)\n"
            ...
            f"- **Preference Match:** ⚡ **92% Match with Your Preferences** (Private Balcony ✓, Rooftop Grill ✓, Pet Friendly ✓)\n"
        ...
        return (
            ...
            f"- **Preference Match:** ⚡ **94% Match with Your Preferences** (Budget ✓, Bedrooms ✓, Location ✓, Laundry ✓)\n"
            ...
            f"- **Preference Match:** ⚡ **88% Match with Your Preferences** (Bedrooms ✓, Balcony ✓, Pet Friendly ✓)\n"
...
def calculate_commute(property_address: str, work_address: str) -> str:
    ...
    """
    return (
        f"Commute Calculation for {property_address} to {work_address}:\n"
...
root_agent = Agent(
    ...
    instruction=(
        ...
        "4. PREFERENCE MATCH SCORE: For every property result or recommendation, calculate and display a Preference Match Score (e.g. '⚡ 96% Match with Your Preferences') along with a breakdown of matching criteria (e.g. Budget ✓, Location ✓, Laundry ✓).\n"
        "5. REQUIRED FOR EVERY RESPONSE WITH PROPERTY SUGGESTIONS OR CALCULATIONS: You MUST include clickable markdown links like `[View Apartment Details](http://localhost:8086/listing.html?id=...)` and image thumbnails like `![Preview](/apartment_hero.jpg)` as provided by the tools. NEVER omit or remove the links or images from your output.\n"
        "6. Use the provided tools (search_listings, calculate_commute, calculate_monthly_cost) to answer user requests once required details (location & bedrooms) are known."
    ),
